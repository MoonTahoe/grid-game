...
//
//  TODO: Rectangle grids don't work 3x8, etc, because of the rotate functions I believe
//
...
var GameFunctions = (function (_EventEmitter) {
    _inherits(GameFunctions, _EventEmitter);

    function GameFunctions(rate, multiple) {
        _classCallCheck(this, GameFunctions);

        _get(Object.getPrototypeOf(GameFunctions.prototype), 'constructor', this).call(this);
...
var Game = (function (_GameFunctions) {
    _inherits(Game, _GameFunctions);
    ...
    function Game() {
        ...
        _get(Object.getPrototypeOf(Game.prototype), 'constructor', this).call(this, 0.5, multiple);
